...
from YOLO.yolov4 import Create_Yolo, compute_loss
from YOLO.utils import load_yolo_weights
...
def main():
    ...
    def train_step(image_data, target):
        with tf.GradientTape() as tape:
            ...
            optimizer.lr.assign(lr.numpy()) #更新学习率
            ...
            #强制缓冲区写入日志
            writer.flush()
        #[次数、学习率、giou_loss、conf_loss、prob_loss、total_loss]
