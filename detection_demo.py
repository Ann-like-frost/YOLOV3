...
from YOLO.utils import detect_image, detect_realtime, detect_video, Load_Yolo_model, detect_video_realtime_mp
...
detect_image(yolo, image_path, "./IMAGES/15_pred.jpg", input_size=YOLO_INPUT_SIZE, show=True, rectangle_colors=(255,0,0))
